...
<div class="related row">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td><?= h($accounts->consumer_key) ?></td>
            <td><?= h($accounts->consumer_secret) ?></td>
            <td><?= h($accounts->access_token) ?></td>
            <td><?= h($accounts->access_token_secret) ?></td>
