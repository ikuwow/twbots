...
class TweetsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'num_tweeted' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'tweets_ibfk_1' => ['type' => 'foreign', 'columns' => ['account_id'], 'references' => ['accounts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'num_tweeted' => 1,
            'created' => '2015-03-30 03:02:10',
            'modified' => '2015-03-30 03:02:10'
        ],
    ];
}
